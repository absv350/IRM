...
object JsonSchemaforIMP {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //print(opts("sourceSchemaFile"))

    val spark=SparkSession.builder().appName("JsonSchemaforIMP").master("local").getOrCreate()
    val schema = getSchema("C:\\Users\\ABLK560\\Desktop\\SYNERGY\\SngyActions_Schema.txt")
    //print(schema)
    ...
    val df = spark.read
      ...
      .option("delimiter", "~")
      .schema(structSchema)
      .parquet("C:\\Users\\ABLK560\\Desktop\\SYNERGY\\Actions")
    ...
    Files.write(Paths.get("C:\\Users\\ABLK560\\Desktop\\SYNERGY\\SngyActions.json"), schemaJson.getBytes)
  }}
