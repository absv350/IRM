...
object JsonSchemaforIMP {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val schema = getSchema("C:\\Users\\ab006gy\\Desktop\\CNTR\\RiskEvents_Schema.txt")
    //print(schema)
    ...
    val df = spark.read
      ...
      .option("delimiter", "~")
      .schema(structSchema)
      .parquet("C:\\Users\\ab006gy\\Desktop\\CNTR\\RiskEvents")
    ...
    Files.write(Paths.get("C:\\Users\\ab006gy\\Desktop\\CNTR\\RiskEvents.json"), schemaJson.getBytes)
  }}
